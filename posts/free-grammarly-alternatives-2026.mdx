...
<Figure
  src="/blog-screenshots/free-grammarly-alternatives/grammarly-premium-popup.svg"
  alt="Grammarly browser extension showing a Premium-only suggestion locked behind an upgrade prompt"
  caption="The Premium nudge: tooltips flagging suggestions the free tier won't expand on. Frequency depends on document but it's most days."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-grammarly-alternatives/grammarly-pricing.svg"
  alt="Grammarly Premium pricing page showing $12 per month or $144 per year"
  caption="Grammarly Premium pricing as captured. $12/month month-to-month, $144/year billed annually."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-grammarly-alternatives/grammar-comparison-output.svg"
  alt="Same paragraph corrected by Grammarly, LanguageTool and Pickrack shown side by side"
  caption="Same input paragraph through three tools. Grammarly rewrites for tone (changing voice); LanguageTool and Pickrack fix only objective errors and keep the writer's voice."
  pending
/>
