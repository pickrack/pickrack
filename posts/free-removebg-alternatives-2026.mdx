...
<Figure
  src="/blog-screenshots/free-removebg-alternatives/removebg-credit-paywall.svg"
  alt="Remove.bg credit purchase prompt after exceeding the free preview"
  caption="The remove.bg paywall: you can see the result, but downloading full resolution requires buying credits."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-removebg-alternatives/removebg-pricing.svg"
  alt="Remove.bg pricing showing $0.20 per HD image and subscription tiers"
  caption="Remove.bg pricing as captured. Pay-as-you-go is $0.20 per HD image; volume subscriptions discount further."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-removebg-alternatives/bgremoval-result-grid.svg"
  alt="Same portrait photo with background removed by 4 different tools side by side"
  caption="Same source portrait, 4 different tools. Edge quality on hair and fine details is where the gaps show up — compare the strands at 200% zoom."
  pending
/>
