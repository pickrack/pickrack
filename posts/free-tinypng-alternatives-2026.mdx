...
<Figure
  src="/blog-screenshots/free-tinypng-alternatives/tinypng-500kb-limit.svg"
  alt="TinyPNG file size limit warning"
  caption="TinyPNG's quiet wall: 5 MB ceiling per file on the free web tool and 20 images per batch. Hit the wall and the upgrade prompt appears."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-tinypng-alternatives/pickrack-compressor-ui.svg"
  alt="Pickrack Image Compressor UI showing quality slider and before/after file size"
  caption="The Pickrack compressor in action — JPG quality slider on the left, file size delta visible on the right. Browser-side, nothing uploads."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-tinypng-alternatives/tinypng-pricing.svg"
  alt="TinyPNG Pro pricing page showing $39 per year for individuals"
  caption="TinyPNG Pro pricing as captured. Unlimited compressions and Photoshop plugin behind the $39/year tier."
  pending
/>
...
<Figure
  src="/blog-screenshots/free-tinypng-alternatives/compression-quality-grid.svg"
  alt="Same source JPG compressed by 5 different tools shown side by side"
  caption="Same 4 MB source JPG (a portrait at 4000×3000) compressed by all five tools at visually-lossless target. Output crops shown at 100% pixel zoom for direct comparison."
  pending
/>
