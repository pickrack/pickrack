...
<Figure
  src="/blog-screenshots/pickrack-vs-ilovepdf/ilovepdf-quota-hit.svg"
  alt="iLovePDF free-tier quota limit reached message"
  caption="iLovePDF caps free users at roughly 30 conversions per day and 200 MB per task. Hit either and you see a soft paywall."
  pending
/>
...
<Figure
  src="/blog-screenshots/pickrack-vs-ilovepdf/merge-side-by-side.svg"
  alt="Side by side merge result: same 3 input PDFs merged by Pickrack and by iLovePDF"
  caption="Same three input PDFs, same compression level — output PDFs are bit-for-bit different in metadata but visually identical. Both use pdf-lib-class engines."
  pending
/>
...
<Figure
  src="/blog-screenshots/pickrack-vs-ilovepdf/ilovepdf-pricing.svg"
  alt="iLovePDF Premium pricing page showing $9.99 per month or $79.99 per year"
  caption="iLovePDF Premium pricing as captured on the date of writing. Annual save 16%."
  pending
/>
